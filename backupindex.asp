...
<% ConditionalDisplay(access_purchase || access_free, "end"); %>
							...
							<td>
								<table border="0" width="100%" cellspacing="0" cellpadding="4">
									<tr>
										...
										<td><input type="text" name="username" maxlength="127" size="25" value="<% write(GetSessionVar("username")); %>"/></td>
									</tr>
									<tr>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="4">
						<tr>
							...
							<td align="right"><input type="submit" name="login" id="loginButton" value="Proceed" /></td>
						</tr>
					</table>
				</form>
			</div>
